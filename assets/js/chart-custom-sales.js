...
let sales_data = yesterdayData.reduce((total, item) => total + item.sales, 0).toFixed(2);
$('#yesterdars_sales').text(new Intl.NumberFormat('en-US', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(sales_data));
sales_data = yesterdayData.reduce((total, item) => total + item.quantity, 0).toFixed(0);
$('#yesterdars_units').text(new Intl.NumberFormat('en-US', { maximumFractionDigits: 0, minimumFractionDigits: 0 }).format(sales_data));
...
if(jQuery('#chart-yesterday-sales').length){
  var chart = new ApexCharts(
      document.querySelector("#chart-yesterday-sales"),
      options
  );
  chart.render();
}
...
sales_data = montlyData.reduce((total, item) => total + item.sales, 0).toFixed(2);
$('#montly_sales').text(new Intl.NumberFormat('en-US', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(sales_data));
sales_data = montlyData.reduce((total, item) => total + item.units, 0).toFixed(0);
$('#montly_units').text(new Intl.NumberFormat('en-US', { maximumFractionDigits: 0, minimumFractionDigits: 0 }).format(sales_data));
...
if(jQuery('#chart-montly-sales').length){
  var chart = new ApexCharts(
      document.querySelector("#chart-montly-sales"),
      options
  );
  chart.render();
}
...
sales_data = yearData.reduce((total, item) => total + item.sales, 0).toFixed(2);
$('#year_sales').text(new Intl.NumberFormat('en-US', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(sales_data));
sales_data = yearData.reduce((total, item) => total + item.units, 0).toFixed(0);
$('#year_units').text(new Intl.NumberFormat('en-US', { maximumFractionDigits: 0, minimumFractionDigits: 0 }).format(sales_data));
...
if(jQuery('#chart-year-sales').length){
  var chart = new ApexCharts(
      document.querySelector("#chart-year-sales"),
      options
  );
  chart.render();
}
...
// Crear una nueva instancia de la fecha para el inicio del año
var inicioDelAnio = new Date(fechaActual.getFullYear(), 0, 1);
// Calcular la diferencia en milisegundos entre las dos fechas
var diferenciaEnMilisegundos = fechaActual - inicioDelAnio;
// Convertir la diferencia de milisegundos a días
var diasPasados = Math.floor(diferenciaEnMilisegundos / (1000 * 60 * 60 * 24));

let totales = yearData.map(function(venta) {return venta.sales;});
let suma = totales.reduce(function(acumulador, total) { return acumulador + total; }, 0);
$('#average_sales').text(new Intl.NumberFormat('en-US', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(suma / diasPasados));
let totalesUnits = yearData.map(function(venta) {return venta.units;});
let sumaUnits = totalesUnits.reduce(function(acumulador, total) { return acumulador + total; }, 0);
$('#average_units').text(new Intl.NumberFormat('en-US', { maximumFractionDigits: 0, minimumFractionDigits: 0 }).format(sumaUnits / diasPasados));

let montly_data_last_year = montlyDataLastYear.reduce((total, item) => total + item.sales, 0);
let montly_data_year = montlyData.reduce((total, item) => total + item.sales, 0);
let variance = (montly_data_year - montly_data_last_year) / montly_data_last_year;
$('#average_sales_last_year').text(new Intl.NumberFormat('en-US', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(montly_data_year-montly_data_last_year));
$('#average_percentage_last_year').text(new Intl.NumberFormat('en-US', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(variance));

let montly_data_last_month = lastMontlyData.reduce((total, item) => total + item.sales, 0);
variance = (montly_data_year - montly_data_last_month) / montly_data_last_month;
$('#average_sales_prio_year').text(new Intl.NumberFormat('en-US', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(montly_data_year-montly_data_last_month));
$('#average_percentage_prio_year').text(new Intl.NumberFormat('en-US', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(variance));
...
//layou-1
  ...
  let monthlySales = montlyData.reduce((total, item) => total + item.sales, 0);
  var options = {
    series: [73.33, 66.66],
